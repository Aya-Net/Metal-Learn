...
class Shader {
  ...
  public:
    ...
    MTL::RenderPipelineState* createPipeline(MTL::Device* device, MTL::VertexDescriptor* vertexDescriptor, MTL::RenderPipelineColorAttachmentDescriptor *colorAttachmentDescriptor = nullptr);
    ~Shader();
